...
import {
  FormField, FormItem, FormControl, FormMessage, Form, FormDescription, FormLabel
...
const SignupFormSchema = z.object({
  ...
  email: z.string().email("Invalid email address.")
    .refine(email => email.toLowerCase().endsWith('@bc.edu') || email.toLowerCase().endsWith('@vanderbilt.edu'), {
